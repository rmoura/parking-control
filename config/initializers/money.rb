...
MoneyRails.configure do |config|
  ...
  #   column_name: nil,  # full name (overrides prefix, postfix and accessor name)
...
# Monkeypatching #as_json to return the float numeric representation
# of the money value instance
class Money
